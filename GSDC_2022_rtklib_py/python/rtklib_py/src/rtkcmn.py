...
def tracemat(level, msg, mat, fmt='.6f'):
    ...
    if len(mat.shape) == 1 or mat.shape[1] == 1:
        ...
        # NOTE - This error message (line 777 to 780) from line 775: fixed with line 781
        # File "/home/akpo/GSDC_2022_rtklib_py/python/rtklib_py/src/rtkcmn.py", line
        # 775, in tracemat
        # sys.stderr.write(' '.join(map(fmt.format, mat)))
        # TypeError: unsupported format string passed to numpy.ndarray.__format__
        sys.stderr.write(' '.join(map(lambda mat: str(mat), mat.round(6))))
        # Reference for line 781: https://stackoverflow.com/questions/52823128/unsupported-format-string-passed-to-numpy-ndarray
        sys.stderr.write('\n')
    else:
        trace(level, msg + '\n')
        for row in mat:
