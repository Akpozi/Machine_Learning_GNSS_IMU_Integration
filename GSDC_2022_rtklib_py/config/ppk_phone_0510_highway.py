...
from python.rtklib_py.src.rtkcmn import uGNSS, rSIG
...
# changes made 20220811 for HIGHWAY
elmin = 10               # minimum elevation for float solution (degrees)
cnr_min = 20             # min signal strength (dB-Hz)
...
thresdop = 3  # 5        # cycle slip detection by doppler method
